...
class PostGame():
    ...
    def update(self):
        ...
        game_over.centerx, game_over.y = 480, (540 - height) / 2
        stats_numbers.centerx, stats_numbers.y = 480, game_over.bottom + 20
        stats_percentage.centerx, stats_percentage.y = 480, stats_numbers.bottom + 20
